        ...
        <div className="hidden lg:flex w-full max-w-xl items-center">
            <div className="relative w-full">
              ...
              <Input
                ...
                className="w-full rounded-md border-2 border-primary/30 bg-secondary/50 pl-10 pr-4"
              />
          </div>
        </div>
       ...
       <div className="container mx-auto px-4 pb-3 lg:hidden">
         <div className="relative w-full">
            ...
            <Input
              type="search"
              placeholder="Search for products..."
              className="w-full rounded-md border-2 border-primary/30 bg-secondary/50 pl-10 pr-10"
            />
